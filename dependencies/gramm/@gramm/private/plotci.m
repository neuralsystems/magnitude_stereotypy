            ...
            for k=1:length(geom)
                switch geom{k}
                   ...
                   case 'edge_bar'
                    ...
                    case 'point'
                        hndl.point_handle=plot(x,y,draw_data.marker,'MarkerEdgeColor','k','markerSize',draw_data.point_size,'MarkerFaceColor',[0.6 0.6 0.6]);
                    case 'mean_line'
                        hndl.point_handle=plot([x-x/5 x+x/5],[y y],'k-','LineWidth',draw_data.line_size);
                end
